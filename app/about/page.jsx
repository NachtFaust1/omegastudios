...
export default function About() {
    ...
    return (
        <>
            <div className="w-full min-h-[20rem] bg-secondary flex items-center">
            ...
            <div className="container w-full mt-12">
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 w-full mt-5 justify-start items-center">
                        {team.map((m) => (
                            <div className="w-full flex items-center justify-center bg-_gray-700 p-6 rounded-lg gap-6">
                                ...
                                <div className="w-full flex flex-col">
                                    ...
                                    <p className="text-zinc-500 text-[14px]">{m.role}</p>
                                </div>
                            </div>
                        ))}
                    </div>
