                ...
                <div className="container space-y-12 py-24">
                    ...
                    <div className="lg:grid grid-cols-1 lg:grid-cols-2 gap-6 space-y-6 lg:space-y-0">
                        <div className="space-y-1">
                            ...
                            <input className="w-full placeholder-gray-400 bg-_secondary px-6 py-3 !outline-none rounded-xl text-white border-2 border-_gray-500 hover:border-_gray-400 active:border-_gray-300 transition-colors duration-200" placeholder="John Doe" type="text" name="user_name" required />
                        </div>
                        <div className="space-y-1">
                            <label className="text-gray-400 text-sm">Your Email</label>
                            <input className="w-full placeholder-gray-400 bg-_secondary px-6 py-3 !outline-none rounded-xl text-white border-2 border-_gray-500 hover:border-_gray-400 active:border-_gray-300 transition-colors duration-200" placeholder="johndoe@gmail.com" type="email" name="email" required />
                        </div>
                        <div className="space-y-1">
                            ...
                            <div className="relative mt-1">
                                <Listbox value={selectedLink} onChange={setSelectedLink}>
                                    <Listbox.Button className="w-full bg-_secondary px-6 py-3 text-left !outline-none rounded-xl text-white border-2 border-_gray-500 hover:border-_gray-400 active:border-_gray-300 transition-colors duration-200">
                                        {selectedLink.name}
                                        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-4">
                                            <i className="fas fa-chevron-down text-gray-400"></i>
                                        </span>
                                    </Listbox.Button>
                                    <Listbox.Options className="absolute mt-1 space-y-1 max-h-60 w-full overflow-auto rounded-md bg-_secondary border-2 border-_gray-500 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" >
                                        {dropLinks.map((link) => (
                        ...
                        <div className="col-span-2">
                            <div className="space-y-1">
                                ...
                                <textarea className="w-full placeholder-gray-400 bg-_secondary px-6 py-3 !outline-none rounded-xl text-white border-2 border-_gray-500 hover:border-_gray-400 active:border-_gray-300 transition-colors duration-200" placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, nisl nec ultricies lacinia, nisl nisl aliquet nisl, eget aliquam nisl nisl eget nisl. Sed euismod, nisl nec ultricies lacinia, nisl nisl aliquet nisl, eget aliquam nisl nisl eget nisl." type="text" name="comment" rows="6" required />
                            </div>
                        </div>
                    </div>
                    <div className="flex justify-end">
                        <button type="submit" className="w-full lg:w-2/5 justify-center flex items-center group gap-2 border-_gray-800 border-[1.5px] bg-_gray-900/20 hover:bg-_gray-900/50 active:bg-_gray-900/80 transition-all duration-200 px-8 py-3 rounded-xl">
                            <p className="text-gray-200 transition-all duration-200">Submit <i className="fas fa-paper-plane ml-2"></i></p>
                        </button>
                    </div>
                </div>
            </form>
